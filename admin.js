...
function renderPatterns() {
    ...
    patternGrid.innerHTML = `<div class="pattern-card"><span class="card-title">Pattern detection ready</span><span class="card-desc">Patterns will be shown once there are enough paired responses across questions.</span></div>`;
}
...
async function handleFetchReel() {
    ...
    try {
        ...
        const d = json.data;
        const title = (d.title || d.author || '').trim();
